...
Note that the current master branch of this repo contains a version of Designer Content that is only compatible with Concrete5.5.0 and up. If you need the older version that is compatible with Concrete5.4.2.2 and below, download the "v2.1.3" tag (click the "Tags" tab above).