		        ...
		        <div class="designer-content-field" data-id="${id}" data-type="${type}">
					...
					<div class="designer-content-field-header">
						<div class="designer-content-field-title">
							...
							[<a href="#" class="designer-content-field-duplicate" data-id="${id}" data-type="${type}"><?php echo t('duplicate'); ?></a><span class="designer-content-field-duplicate-confirm" data-id="${id}" data-type="${type}" style="display: none;">Are you sure? <a href="#" class="designer-content-field-duplicate-yes" data-id="${id}" data-type="${type}"><?php echo t('Yes'); ?></a> / <a href="#" class="designer-content-field-duplicate-no" data-id="${id}" data-type="${type}"><?php echo t('No'); ?></a></span>]
						</div>
